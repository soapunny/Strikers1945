...
{
public:
	enum SKILLTYPE { NormalSkillTYPE, ZigzagSkillTYPE, CircularSkillTYPE, GuidedSkillTYPE, PlayerSkillTYPE, MeteorSkillTYPE, WormSKillTYPE, TwoSKillTYPE, NotSkillTYPE, TornadoSkillTYPE};
