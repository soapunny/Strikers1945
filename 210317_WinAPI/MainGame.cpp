...
void MainGame::Render()
 {
	...
	{ 
		...
		{
			status++;
			if (status >= SCENE_STATUS::END_SCENE_STATUS)
				status = SCENE_STATUS::OPENING_SCENE;
	...
	//배경
		...
		{
			status = SCENE_STATUS::ENDING_SCENE;
		}
	}
	else if(status == SCENE_STATUS::ENDING_SCENE)//엔딩 출력
	{
